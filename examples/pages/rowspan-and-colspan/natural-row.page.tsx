...
const App = () => {
  const [naturalRowHeight, setNaturalRowHeight] = useState<boolean>(true);
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        <CheckBox checked={naturalRowHeight} onChange={setNaturalRowHeight}>
          Natural row height
        </CheckBox>
      </div>
      ...
      <ReactDataGrid
        ...
        columns={columns}
        dataSource={people}
        rowHeight={naturalRowHeight ? null : undefined}
        minRowHeight={naturalRowHeight ? 35 : undefined}
      />
    </div>
  );
};
